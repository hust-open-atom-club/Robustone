    ...
    fn supports_modifier(&self, modifier: &str) -> bool {
        match self {
            Architecture::Arm | Architecture::ArmLE | Architecture::ArmBE | Architecture::Thumb => {
                matches!(modifier, "thumb" | "m" | "v8")
            }
            Architecture::Aarch64 | Architecture::Aarch64BE => matches!(modifier, "apple"),
            ...
            | Architecture::MipsEL
            | Architecture::Mips64
            | Architecture::MipsEL64 => matches!(modifier, "nofloat" | "ptr64"),
            ...
            | Architecture::PowerPC64BE => {
                matches!(
                    modifier,
                    "aix" | "booke" | "maix" | "msync" | "qpx" | "ps" | "spe"
                )
            }
